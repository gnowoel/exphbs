...
function attach(exphbs) {
  ...
  exphbs.createFile = createFile;
  // exphbs.renderFile = renderFile;
  exphbs.compileContent = compileContent;
  // exphbs.executeTemplate = executeTemplate;
  // exphbs.findLayout = findLayout;
}
